...
printf '/dev/disk/by-uuid/5650d5fa-aec0-4941-889f-6b785f016ca6 /run/media/leanhtai01/data_drive auto nosuid,nodev,nofail,x-gvfs-show,x-systemd.before=httpd.service 0 0\n' | sudo tee -a /etc/fstab > /dev/null
