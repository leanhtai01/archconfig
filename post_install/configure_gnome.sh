...
# setup favorite-apps
gsettings set org.gnome.shell favorite-apps "['torbrowser.desktop', 'thunderbird.desktop', 'org.gnome.Evince.desktop', 'org.keepassxc.KeePassXC.desktop', 'virt-manager.desktop', 'virtualbox.desktop', 'org.gnome.gedit.desktop']"
