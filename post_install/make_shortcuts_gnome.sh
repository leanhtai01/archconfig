...
# open GVim
gsettings set $SCHEMATOITEM:${PATHTOCUSTOMKEY}4/ name "'GVim'"
gsettings set $SCHEMATOITEM:${PATHTOCUSTOMKEY}4/ binding "'<Primary><Alt>v'"
gsettings set $SCHEMATOITEM:${PATHTOCUSTOMKEY}4/ command "'gvim'"
