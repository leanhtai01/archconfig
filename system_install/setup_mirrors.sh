...
wget -O pkg/fakeroot.pkg.tar.zst https://www.archlinux.org/packages/core/x86_64/fakeroot/download/
wget -O pkg/pacman-contrib.pkg.tar.zst https://www.archlinux.org/packages/community/x86_64/pacman-contrib/download/
