...
# tools
$install_command wimlib transmission-gtk keepassxc expect pacman-contrib deja-dup curl lm_sensors dosfstools ntfs-3g p7zip unarchiver gparted bash-completion bchunk ibus filezilla flatpak cdemu-client vhba-module-dkms cdrtools fuseiso efitools sbsigntools
