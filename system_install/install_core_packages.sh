...
$install_command gdb cmake git go valgrind dia clang gcc python github-cli intellij-idea-community-edition jdk-openjdk java-openjfx jdk8-openjdk java8-openjfx jupyterlab netbeans julia python-nltk python-pandas python-pip python-numpy tk dotnet-sdk nodejs eslint npm pycharm-community-edition
...
# office and learning
$install_command calibre kchmviewer goldendict kolourpaint thunderbird libreoffice-fresh gimp okular sweethome3d hexchat gnucash step librecad gimp inkscape geogebra
