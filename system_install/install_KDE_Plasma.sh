...
then
    # core
    $install_command plasma-desktop plasma-wayland-session ark dolphin dolphin-plugins kate konsole kdegraphics-thumbnailers ffmpegthumbs spectacle gwenview bluedevil khotkeys kinfocenter kscreen
else
    # full
