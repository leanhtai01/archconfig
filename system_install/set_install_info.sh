...
system_install_type="core python java javascript dotnet desktop games" # {core optional python java javascript high_performance dotnet desktop games}
simple_setup_mirror=
install_pipewire_audio_server="n"
