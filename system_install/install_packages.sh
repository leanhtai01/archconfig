...
# games
arch-chroot /mnt pacman -Syu --needed --noconfirm kigo bovo gnuchess supertuxkart wesnoth minetest minetest-server teeworlds kbounce steam steam-native-runtime widelands 0ad hedgewars
